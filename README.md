...
Windows       | [![Build Status](https://build.osrfoundation.org/buildStatus/icon?job=gz_plugin-3-clowin)]([https://build.osrfoundation.org/job/gz_plugin-3-win](https://build.osrfoundation.org/job/gz_plugin-3-clowin/))
