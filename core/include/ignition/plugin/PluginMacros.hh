...
#ifndef IGNITION_PLUGIN_REGISTERMACROS_HH_
#define IGNITION_PLUGIN_REGISTERMACROS_HH_
...
///         {
///           public:
///             IGN_PLUGIN_SPECIALIZE_INTERFACE(mylibrary::ns::SomeInterface)
...
#define IGN_PLUGIN_SPECIALIZE_INTERFACE(interfaceName)\
  DETAIL_IGN_PLUGIN_SPECIALIZE_INTERFACE(interfaceName)
 ...
 *       IGN_PLUGIN_ADD_PLUGIN(mylibrary::ns::SomeClass1, mylibrary::ns::SomeInterface)
 *       IGN_PLUGIN_ADD_PLUGIN(mylibrary::ns::SomeClass2, mylibrary::ns::SomeInterface)
 ...
 *
 *     IGN_PLUGIN_BEGIN_ADDING_PLUGINS
 *       IGN_PLUGIN_ADD_PLUGIN(mylibrary::ns::SomeClass, mylibrary::ns::Interface1)
 *       IGN_PLUGIN_ADD_PLUGIN(mylibrary::ns::SomeClass, mylibrary::ns::Interface2)
 *     IGN_PLUGIN_FINISH_ADDING_PLUGINS
 *
 *
 ...
 *
 *     IGN_PLUGIN_BEGIN_ADDING_PLUGINS
 *       IGN_PLUGIN_ADD_PLUGIN(mylibrary::ns::SomeClass, mylibrary::ns::FooInterface)
 *       IGN_PLUGIN_ADD_PLUGIN(mylibrary::ns::SomeOtherClass, mylibrary::ns::BarInterface)
 *       IGN_PLUGIN_ADD_PLUGIN(mylibrary::ns::SomeClass, mylibrary::ns::SomeInterface)
 *       IGN_PLUGIN_ADD_PLUGIN(mylibrary::ns::SomeOtherClass, mylibrary::ns::FooInterface)
 *       IGN_PLUGIN_ADD_PLUGIN(mylibrary::ns::SomeOtherClass, mylibrary::ns::SomeInterface)
 *     IGN_PLUGIN_FINISH_ADDING_PLUGINS
 */
...
// IGN_PLUGIN_BEGIN_ADDING_PLUGINS more than once in your library, then you are
...
/// IGN_PLUGIN_ADD_PLUGIN(~,~), passing in a different plugin and interface name
...
#define IGN_PLUGIN_BEGIN_ADDING_PLUGINS\
  DETAIL_IGN_PLUGIN_BEGIN_ADDING_PLUGINS
...
/// IGN_PLUGIN_BEGIN_ADDING_PLUGINS and IGN_PLUGIN_FINISH_ADDING_PLUGINS. If a
...
#define IGN_PLUGIN_ADD_PLUGIN(plugin, interface)\
  DETAIL_IGN_PLUGIN_ADD_PLUGIN(plugin, interface)


/// \brief Call this macro after all calls to IGN_PLUGIN_ADD_PLUGIN have been
/// finished.
#define IGN_PLUGIN_FINISH_ADDING_PLUGINS\
  DETAIL_IGN_PLUGIN_FINISH_ADDING_PLUGINS


// -------------- Add a single plugin with a single interface -----------------

/// \brief Register a shared library with only one plugin and one interface.
/// This macro is NOT compatible with IGN_PLUGIN_ADD_PLUGIN or any of the
...
#define IGN_PLUGIN_REGISTER_SINGLE_PLUGIN(plugin, interface) \
  IGN_PLUGIN_BEGIN_ADDING_PLUGINS\
    IGN_PLUGIN_ADD_PLUGIN(plugin, interface)\
  IGN_PLUGIN_FINISH_ADDING_PLUGINS
